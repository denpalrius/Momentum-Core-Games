...
if (score >= 500)
 {
      document.getElementById("canvas").style.background = "url(img/rstarsbgb.png) top left";
	  showFact1();
...
if (score >= 700)
	  ...
	  if (score >= 1000)
	  {
	  document.getElementById("canvas").style.background = "url(img/rstarsbgc.png) top left";
	  showFact2();
     score = score;
	   if (score >= 1200)
	  {
     ...
     score = score;
	  ...
	  if (score >= 2000)
	  {
	  document.getElementById("canvas").style.background = "url(img/rstarsbgd.png) top left";
	  showFact4();
     score = score;
	   if (score >= 2200)
	  {
     ...
     score = score;
	  ...
	  if (score >= 3000)
	  {
	  document.getElementById("canvas").style.background = "url(img/rstarsbge.png) top left";
	  showFact6();
     score = score;
	   if (score >= 3200)
	  {
	 ...
	 document.getElementById("canvas").style.background = "url(img/rstarsbg.png) top left";
  ...
  function gameOver() {
    ...
    if(player.y > height/2 && flag === 0) {
      ...
      tweet.href='http://twitter.com/share?url=http://momentumcore.com/simiyu&text=I just scored ' +score+ ' points in Simiyu The Chicken  game!&count=horiztonal&via=momentumcore&related=solitarydesigns';
    
      var facebook = document.getElementById("fbBtn");
      facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://momentumcore.com/simiyu=I just scored ' +score+ ' points in the Simiyu The Chicken game!&p[summary]=Can you beat me in this awesome recreation of Momentum Core?';
...
//Shows the fact1
function showFact1() {
  var menu = document.getElementById("fact1");
  menu.style.zIndex = 1;
  menu.style.visibility = "visible";
...
function showFact2() {
  var menu = document.getElementById("fact2");
  menu.style.zIndex = 1;
  menu.style.visibility = "visible";
...
function showFact3() {
  var menu = document.getElementById("fact3");
  menu.style.zIndex = 1;
  menu.style.visibility = "visible";

}
function showFact4() {
  var menu = document.getElementById("fact4");
  menu.style.zIndex = 1;
  menu.style.visibility = "visible";

}
function showFact5() {
  var menu = document.getElementById("fact5");
  menu.style.zIndex = 1;
  menu.style.visibility = "visible";

}
function showFact6() {
  var menu = document.getElementById("fact6");
  menu.style.zIndex = 1;
  menu.style.visibility = "visible";

}

//Shows the stage menu
function showLevel2() {
  var menu = document.getElementById("level2");
  menu.style.zIndex = 2;
  menu.style.visibility = "visible";
